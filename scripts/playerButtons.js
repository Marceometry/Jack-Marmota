buttons = {
    ...
    mute() {
        if (audio.muted) {
            audio.muted = false
            mute.src = './media/icons/volume_up-24px.svg'
        } else {
            audio.muted = true
            mute.src = './media/icons/volume_off-24px.svg'
        }
    },
    ...
    toggleRepeat() {
        if (repeat.src.indexOf('repeat-24px.svg')!=-1) {
            repeat.src = './media/icons/repeat_one-24px.svg';
        } else {
            repeat.src = './media/icons/repeat-24px.svg';
        }
    ...
    play() {
        audio.play()
        playPause.src = './media/icons/pause-24px.svg'
    },

    pause() {
        audio.pause()
        playPause.src = './media/icons/play_arrow-24px.svg'
    },
